...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'SwiftySignals provides a simple alternative to the observer pattern by providing signals and observable properties.'
...
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  ...
  s.source           = { :git => 'https://github.com/psturm-swift/SignalSlot4Swift.git', :tag => s.version.to_s }
